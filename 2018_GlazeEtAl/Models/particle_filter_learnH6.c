...
{
    double F, K, *H0pr, *xpr, *musgnpr, *Lexp_pr, partM, *etapr, etalen, *Lvar_pr, maxL;
    int N, Hlen, simN;
    ...
    particle_filter_learnH6(K,H0pr,Hlen,xpr,musgnpr,Lexp_pr,N,partM,simN,F,etapr,etalen,Lvar_pr);
