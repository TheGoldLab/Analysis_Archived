...
{
    double *qexpr, *Hexpr, *l1pr, *l2pr, *Hpr, *Evpr, K, *pHpr, *musgnpr, *Hmatpr;
    int N, M;
    ...
    Hmatpr = mxGetPr(plhs[2]);
    
    /* Do the actual computations in a subroutine */
    HHMM_mixed_mat_c(qexpr,Hexpr,l1pr,l2pr,Hpr,pHpr,K,N,M,musgnpr,Hmatpr);
