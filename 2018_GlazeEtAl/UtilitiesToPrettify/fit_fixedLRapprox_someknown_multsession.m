function [paramstrct] = fit_fixedLRapprox_someknown_multsession(xarr,choicearr,musgnarr,sigmavc,mu,fixedparamstrct)
...
paramstrct.params = paramsfinal;
    ...
    function e = fit_dsprt_min(params)
        ...
        LL = getfit_fixedvar_gauss_fixedLRapprox_arr(xarr,choicearr,musgnarr,sigmavc,mu,params2,eta0);
        e = -1*LL;
