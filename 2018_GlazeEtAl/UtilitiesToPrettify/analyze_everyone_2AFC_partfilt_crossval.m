...
fit_dir = [dirnm(1:strfind(dirnm,'Dropbox')+19) filesep 'fit_data' filesep];
...
load random_session_partitions.mat sessionindsarr


load([fit_dir 'allparam_fixedvarfits_partfilt_sigma_partMfixed20.mat'],'paramstrct_sigma_partMfixed')
