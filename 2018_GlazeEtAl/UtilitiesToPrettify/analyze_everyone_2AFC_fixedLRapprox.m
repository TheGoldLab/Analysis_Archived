...
fixedparamstrct.varnms = {'logalpha','H0','psi','whoops','sigma0','gamma','logc'};
fixedparamstrct.params0 = [log(.001) .4 1 .0025 10 1 log(5)];
fixedparamstrct.ub = [log(.5) .999 5 .02 20 1.5 log(10)];
fixedparamstrct.lb = [-15 .001 0 0 2 0 log(.0001)];
fixedparamstrct.free = logical([1 1 1 1 0 0 0]);
...
for subjind = 1:length(subjids)
    ...
    %    fixedparamstrct_subj.params0(subjind,fixedparamstrct.free) = paramat(subjind,fixedparamstrct.free);
        paramstrct_fixedLRapprox_sigmafixed(subjind) = fit_fixedLRapprox_leakvary_someknown_multsession(xarr,choicearr,musgnarr,sigmavc,mudist,fixedparamstrct_subj);
