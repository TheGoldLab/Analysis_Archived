function [wavg, wse] = getML_RLFigS11AvgWSortedByTh(Monk, NSEN, NTUNE, ELN, DIRS, SIMNUM, TRIALS, THBINS, DFLAG, recompute)
% Get average weights for each trial in TRIALS bined by THBINS

%%
[h] = dirnames;
fn  = ['getML_RLFigS11AvgWSortedByTh_' int2str(DFLAG), '_' 'Monk' '.mat'];
