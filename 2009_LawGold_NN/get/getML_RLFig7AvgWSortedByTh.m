function [wavg, wse] = getML_RLFig7AvgWSortedByTh(Monk, NSEN, NTUNE, ELN, DIRS, SIMNUM, TRIALS, THBINS, recompute)
% Get average weights for each trial in TRIALS bined by THBINS
% (for fine discrimination task)
%%
[h] = dirnames;
fn  = ['getML_RLFig7AvgWSortedByTh_' Monk '.mat'];
