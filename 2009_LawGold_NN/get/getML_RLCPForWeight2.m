function [cp, rALL, choice] = getML_RLCPForWeight2(Monk, NSEN, NTUNE, W, MTindex, N, TAG, RECOMPUTE)
...
% NOTE: constant correlation structure

[hdir, ldir, cdir, tdir] = dirnames;
savepath = [tdir '/getML_RLCP2_' Monk '_' int2str(NSEN) '_' int2str(NTUNE) TAG '_' int2str(N) '.mat'];
