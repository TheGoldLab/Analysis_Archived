function [FIRA, W, MTindex] = getML_RLSimPerceptualLearningNonLinPool(Monk, NSEN, NTUNE, eln, DIRS, MTDIRS, SIMNUM, nl, RECOMPUTE)
...
savepath = [tdir '/getML_RLNonLinPool_' Monk '_' num2str(nl) '_' int2str(NSEN) '_' int2str(NTUNE) '_' num2str(eln) '_v' num2str(SIMNUM) '.mat'];
