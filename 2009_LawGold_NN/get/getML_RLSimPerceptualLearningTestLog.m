function [FIRA, W, MTindex] = getML_RLSimPerceptualLearningTestLog(Monk, NSEN, NTUNE, eln, DIRS, SIMNUM, beta, RECOMPUTE)
...
% 
% Test different, fixed values of the logistic function 
%

[hdir, ldir, cdir, tdir] = dirnames;
savepath = [tdir '/getML_RLLog_' Monk '_' int2str(NSEN) '_' int2str(NTUNE) '_' num2str(eln) '_' num2str(beta) '_v' num2str(SIMNUM) '.mat'];
