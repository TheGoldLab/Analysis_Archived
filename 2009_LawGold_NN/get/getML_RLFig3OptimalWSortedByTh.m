function [wo_sorted, wod_sorted, wocorr_sorted, wocorrd_sorted, wo, wocorr, ind] = getML_RLFig3OptimalWSortedByTh(Monk, NSEN, NTUNE, ELN, DIRS, SIMNUM, THBINS, NORMSCALE, recompute)
...
%%
[h] = dirnames;
fn  = ['getML_RLFig3OptimalWSortedByTh_' Monk '.mat'];
