function [FIRA, W, MTindex] = getML_RLSimPerceptualLearningMulNoise(Monk, NSEN, NTUNE, eln, DIRS, MTDIRS, SIMNUM, RECOMPUTE)
...
% 
% % Multiplicative pooling noise only
% % with weight normalization
% % not fixed directions

[hdir, ldir, cdir, tdir] = dirnames;
savepath = [tdir '/getML_RLMulNoise_' Monk '_' int2str(NSEN) '_' int2str(NTUNE) '_' num2str(eln) '_v' num2str(SIMNUM) '.mat'];
