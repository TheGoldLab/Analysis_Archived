function [FIRA, W, MTindex] = getML_RLSimPerceptualLearning5(Monk, NSEN, NTUNE, eln, DIRS, MTDIRS, SIMNUM, RECOMPUTE)
...
if RECOMPUTE
    ...
    w       = 1e-4*(randn(size(k0)));   % random initial condition for weight
