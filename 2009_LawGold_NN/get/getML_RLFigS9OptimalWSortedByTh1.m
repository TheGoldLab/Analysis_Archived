function [wo_sorted, wod_sorted, wocorr_sorted, wocorrd_sorted, wo, wocorr, ind] = getML_RLFigS9OptimalWSortedByTh1(Monk, NSEN, NTUNE, ELN, DIRS, SIMNUM, THBINS, NORMSCALE, TAG, recompute)
...
%%
[h] = dirnames;
fn  = ['getML_RLFigS9OptimalWSortedByTh1_' TAG '_' Monk '.mat'];
...
if recompute
    ...
    for nn = 1:length(SIMNUM)
        ...
        rsen  = 0.2;       % max correlation between neurons with different sensitivity
