function [wo_sorted, wod_sorted, wocorr_sorted, wocorrd_sorted, wo, wocorr, ind] = getML_RLFig7OptimalWSortedByTh(Monk, NSEN, NTUNE, ELN, DIRS, SIMNUM, THBINS, NORMSCALE, recompute)
...
%%
[h] = dirnames;
fn  = ['getML_RLFig7OptimalWSortedByTh_' Monk '.mat'];
...
if recompute
    ...
    for i = 1:length(SIMNUM)
        ...
        wocorr(:,:,i) = reshape(w_,NSEN,NTUNE);
