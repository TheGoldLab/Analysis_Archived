function [FIRA, W, MTindex] = getML_RLSimPerceptualLearningNoNorm(Monk, NSEN, NTUNE, eln, DIRS, MTDIRS, SIMNUM, RECOMPUTE)
...
savepath = [tdir '/getML_RLNoNorm_' Monk '_' int2str(NSEN) '_' int2str(NTUNE) '_' num2str(eln) '_v' num2str(SIMNUM) '.mat'];
