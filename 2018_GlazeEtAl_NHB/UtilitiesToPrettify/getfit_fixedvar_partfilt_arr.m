function [LL,LLvc,LP] = getfit_fixedvar_partfilt_arr(xarr,choicearr,musgnarr,sigmavc,mu,simN,params,eta0)
...
parfor arrind = 1:arrN
    ...
    choiceexp = particle_filter_learnH7(K_final,H0samps,F,x,musgn,partM,simN,eta);
    choice1 = (1-whoops)*choiceexp + whoops*(1-choiceexp);
