function [LL,LLvc,LP] = getfit_fixedvar_gauss_fixedLRapprox_leakvary_arr(xarr,choicearr,musgnarr,sigmavc,mu,params,eta)
...
parfor arrind = 1:arrN
    ...
    c = 1 + mu/sigmasubj;
    Lexp = fixedLR_learnH6_approx(alpha,c,H0,F,x,musgn,1,eta);
