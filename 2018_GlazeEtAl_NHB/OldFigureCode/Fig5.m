...
[q1exp2,expH_bayes2,pHmat_bayes2] = ...
    HHMM_mixed_mat_c(l1,l2,Hspc2,pH02,K1,musgn);
...
[q1samps,Hsamps2] = particle_filter_learnH(K1,H0samps2,F,x,musgn,Mvc(1),2,zeros(200,1));
...
load regression_sim_r0vary_bayesultimate.mat paramstrct_regress
params_regress = [paramstrct_regress.params]';
params_regress = reshape(params_regress,4,41)';
